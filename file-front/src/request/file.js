 ...
 */
// 获取文件列表（区分文件路径）
export const getFileList = (id, p) => get(`/app/file/folder/${id}`, p)
// 获取文件目录树
 ...
 */
// 创建文件夹
export const createFold = (p) => post('/app/file/folder', p)
// 创建文件
export const createFile = (p) => post('/app/file', p)

// 获取文件详细信息
export const getFileDetail = (p) => get('/file/detail', p)
// 删除文件
export const deleteFile = (id) => axiosDelete(`/file/${id}`, {})
// 复制文件
export const copyFile = (p) => post('/file/copyfile', p)
// 移动文件
export const moveFile = (p) => post('/file/movefile', p)
// 重命名文件
export const renameFile = (id, p) => put(`/app/file/${id}`, p)
// 解压文件
export const unzipFile = (p) => post('/file/unzipfile', p)
// 全局搜索文件
export const searchFile = (p) => get('/app/file', p)
// 分享文件
 ...
 */
// 批量删除文件
export const batchDeleteFile = (id) => axiosDelete(`/app/file/${id}`, {})
// 批量移动文件
