...
func CreateRelationService() *RelationService {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///index.relation"),
...
// AddNode 添加一个节点
func (s RelationService) AddNode(ctx context.Context, name string, info map[string]string) (int64, error) {
...
// GinAddNode 快速添加节点
func (s RelationService) GinAddNode(ctx *gin.Context, name string, data map[string]string) (int64, bool) {
	// 添加一个节点
...
// GetNode 获取节点内容
func (s RelationService) GetNode(ctx context.Context, id int64) (map[string]string, error) {
	...
	return node.Info.Attribute, nil
}
...
// AddRelation 添加一个关系
func (s RelationService) AddRelation(ctx context.Context, start int64, end int64, relationInfo string, info map[string]string) (int64, error) {
...
func (s RelationService) GetNodeChild(ctx context.Context, id int64, relationType string, current int32, size int32) ([]*relation.Node, int64, error) {
...
func (s RelationService) GetNodeParent(ctx context.Context, id int64, relationType string, current int32, size int32) ([]*relation.Node, int64, error) {
