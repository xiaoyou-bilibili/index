...
func (oq *ObjectQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (oq *ObjectQuery) FirstIDX(ctx context.Context) string {
...
func (oq *ObjectQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (oq *ObjectQuery) OnlyIDX(ctx context.Context) string {
...
func (oq *ObjectQuery) IDs(ctx context.Context) ([]string, error) {
	var ids []string
...
func (oq *ObjectQuery) IDsX(ctx context.Context) []string {
	ids, err := oq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	client.Object.Query().
//		GroupBy(object.FieldObjectName).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
